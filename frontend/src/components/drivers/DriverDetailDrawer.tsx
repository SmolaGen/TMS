        ...
        driver ? (
          <Space>
            <Avatar
              ...
              style={{
                backgroundColor:
                  statusConfig[driver.status]?.color === 'success'
                    ? '#52c41a'
        ...
        {driver && (
          <Space direction="vertical" style={{ width: '100%' }} size="large">
            ...
            <Descriptions column={1} size="small">
              ...
              <Descriptions.Item label="Telegram ID">{driver.telegram_id}</Descriptions.Item>
            ...
            <div>
              ...
              {driverLocation ? (
                ...
                <Empty description="Локация недоступна" image={Empty.PRESENTED_IMAGE_SIMPLE} />
              )}
            </div>
          </Space>
        )}
