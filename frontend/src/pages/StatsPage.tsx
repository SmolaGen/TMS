                ...
                <Row gutter={[isMobile ? 12 : 16, isMobile ? 12 : 16]}>
                    <Col xs={24} lg={14}>
                        <Card
                            ...
                            size="small"
                            style={{ background: 'var(--tms-bg-container)', borderRadius: 8, marginBottom: isMobile ? 12 : 16 }}
                        >
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <Text type="secondary" style={{ fontSize: isMobile ? 12 : 13 }}>
                            Период: {dayjs(stats.period.start).format('DD.MM.YYYY')} - {dayjs(stats.period.end).format('DD.MM.YYYY')}
                        </Text>
                    </div>
